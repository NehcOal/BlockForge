...
For `3.0.0-alpha.1`, confirm AI productization remains Alpha, no API key is bundled
...
Expected jars for `3.0.0-alpha.1`:
...
- Manual Minecraft regression testing must remain pending until explicitly
  tested.
# v3.0.0-alpha.1 Release Checklist
...
# v3.0.0-alpha.1 Publishing Notes

`3.0.0-alpha.1` is an alpha candidate. Do not mark it stable.
