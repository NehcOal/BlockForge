...
This guide prepares the `1.2.2-alpha.1` multi-loader Alpha release. It does not
...
1. Create a GitHub release for `v1.2.2-alpha.1`.
2. Use `docs/RELEASE_NOTES_TEMPLATE.md` as the release body starting point.
3. Upload the three loader jars.
4. Label Fabric and Forge clearly as GUI Selector + Builder Wand + Ghost Preview Alpha.
5. Do not claim Fabric or Forge material costs, material refunds, BlockEntity
   NBT undo, collision-aware preview, or full block preview support.
...
- Fabric Alpha: Connector for examples, reload, list, info, dryrun, build,
  GUI selection, rotation, Builder Wand placement, Ghost Preview outline, and undo.
