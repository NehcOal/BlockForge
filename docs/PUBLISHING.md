...
For `4.0.0-beta.1`, confirm AI productization remains Alpha, no API key is bundled
...
Expected jars for `4.0.0-beta.1`:

```text
mod/neoforge-connector/build/libs/blockforge-connector-neoforge-4.0.0-beta.1.jar
mod/fabric-connector/build/libs/blockforge-connector-fabric-4.0.0-beta.1.jar
mod/forge-connector/build/libs/blockforge-connector-forge-4.0.0-beta.1.jar
```
...
- Manual Minecraft regression testing must remain pending until explicitly
  tested.
# v4.0.0-beta.1 Release Checklist
...
# v4.0.0-beta.1 Publishing Notes

`4.0.0-beta.1` is an alpha candidate. Do not mark it stable.
...
`4.0.0-beta.1` can be prepared as a GitHub beta prerelease candidate after all
