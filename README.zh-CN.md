...
v3.5.0-alpha.1 包含 Web 导入工作台、字段级校验报告、本地规则生成器、可选外部
...
BlockForge v3.5.0-alpha.1 新增第一版 Build Planner。它会先把蓝图放置转换成
...
BlockForge v3.5.0-alpha.1 开始把重点转向 Minecraft 内体验，目标是减少玩家
...
BlockForge v3.5.0-alpha.1 新增可选 AI 生成链路，同时继续把本地规则生成器作为默认 fallback。
...
BlockForge v3.5.0-alpha.1 是 Product Workbench Alpha：包含发布就绪整理、
