...
v4.2.0-beta.1 包含 Web 导入工作台、字段级校验报告、本地规则生成器、可选外部
...
BlockForge v4.2.0-beta.1 重点是补齐游戏内 GUI / Station Runtime 的安全公共层，
...
BlockForge v4.2.0-beta.1 新增可选 AI 生成链路，同时继续把本地规则生成器作为默认 fallback。
...
BlockForge v4.2.0-beta.1 是 Product Workbench Alpha：包含发布就绪整理、
