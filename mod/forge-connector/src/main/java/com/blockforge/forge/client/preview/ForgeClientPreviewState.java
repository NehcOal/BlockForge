...
public final class ForgeClientPreviewState {
    private static PreviewState selection;
    private static PreviewTarget target;

    private ForgeClientPreviewState() {
    }

    public static void apply(ForgeBlueprintGuiNetworking.PreviewSelectionPayload payload) {
