...
public final class FabricBlockForgeCommands {
        ...
        CommandRegistrationCallback.EVENT.register((dispatcher, registryAccess, environment) -> dispatcher.register(CommandManager.literal("blockforge")
                ...
                .then(CommandManager.literal("house")
                        .then(CommandManager.literal("presets")
                                .executes(context -> partial(context, "Fabric house presets alpha registered: starter_cottage, medieval_house, farmhouse, workshop, storage_house, watchtower_house, market_house, longhouse.")))
                        .then(CommandManager.literal("create")
                                .then(CommandManager.argument("preset", StringArgumentType.word())
                                        .executes(context -> partial(context, "Fabric house create alpha uses common HousePlan generation; loader preview persistence is partial."))
                                        .then(CommandManager.literal("size")
                                                .then(CommandManager.argument("width", IntegerArgumentType.integer(5, 32))
                                                        .then(CommandManager.argument("depth", IntegerArgumentType.integer(5, 32))
                                                                .then(CommandManager.literal("floors")
                                                                        .then(CommandManager.argument("floors", IntegerArgumentType.integer(1, 4))
                                                                                .executes(context -> partial(context, "Fabric sized house create alpha registered.")))))))))
                        .then(CommandManager.literal("roof")
                                .then(CommandManager.argument("type", StringArgumentType.word())
                                        .executes(context -> partial(context, "Fabric house roof alpha registered."))))
                        .then(CommandManager.literal("materials")
                                .then(CommandManager.argument("wall", StringArgumentType.word())
                                        .then(CommandManager.argument("roof", StringArgumentType.word())
                                                .then(CommandManager.argument("floor", StringArgumentType.word())
                                                        .executes(context -> partial(context, "Fabric house materials alpha registered."))))))
                        .then(CommandManager.literal("preview")
                                .executes(context -> partial(context, "Fabric house preview alpha registered; Blueprint compiler is common, client preview wiring is partial.")))
                        .then(CommandManager.literal("buildplan")
                                .executes(context -> partial(context, "Fabric house BuildPlan alpha registered.")))
                        .then(CommandManager.literal("build")
                                .executes(context -> partial(context, "Fabric house build alpha delegates to existing build flow after blueprint selection.")))
                        .then(CommandManager.literal("quality")
                                .executes(context -> partial(context, "Fabric house quality alpha uses common HouseQualityAnalyzer.")))
                        .then(CommandManager.literal("export")
                                .then(CommandManager.literal("blueprint")
                                        .executes(context -> partial(context, "Fabric house export blueprint alpha registered."))))
                        .then(CommandManager.literal("save")
                                .then(CommandManager.argument("name", StringArgumentType.word())
                                        .executes(context -> partial(context, "Fabric house save alpha registered.")))))
                ...
                .then(CommandManager.literal("settlement")
                        .then(CommandManager.literal("create")
                                .then(CommandManager.argument("name", StringArgumentType.word())
                                        .executes(context -> partial(context, "Fabric settlement create alpha registered."))))
                        .then(CommandManager.literal("info")
                                .executes(context -> partial(context, "Fabric settlement info alpha registered.")))
                        .then(CommandManager.literal("list")
                                .executes(context -> partial(context, "Fabric settlement list alpha registered."))))
                .then(CommandManager.literal("contracts")
                        .then(CommandManager.literal("list")
                                .executes(context -> partial(context, "Fabric contracts alpha: common templates are available; loader persistence is partial.")))
                        .then(CommandManager.literal("info")
                                .then(CommandManager.argument("contractId", StringArgumentType.word())
                                        .executes(context -> partial(context, "Fabric contract info alpha registered."))))
                        .then(CommandManager.literal("accept")
                                .then(CommandManager.argument("contractId", StringArgumentType.word())
                                        .executes(context -> partial(context, "Fabric contract accept alpha registered."))))
                        .then(CommandManager.literal("verify")
                                .then(CommandManager.argument("contractId", StringArgumentType.word())
                                        .executes(context -> partial(context, "Fabric contract verify alpha uses common heuristic rules; world snapshots are pending.")))))
                .then(CommandManager.literal("architect")
                        .then(CommandManager.literal("profile")
                                .executes(context -> partial(context, "Fabric architect profile alpha registered.")))
                        .then(CommandManager.literal("contracts")
                                .executes(context -> partial(context, "Fabric architect contracts alpha registered.")))
                        .then(CommandManager.literal("reputation")
                                .executes(context -> partial(context, "Fabric architect reputation alpha registered."))))
                .then(CommandManager.literal("events")
                        .then(CommandManager.literal("list")
                                .executes(context -> partial(context, "Fabric settlement events alpha registered.")))
                        .then(CommandManager.literal("info")
                                .then(CommandManager.argument("eventId", StringArgumentType.word())
                                        .executes(context -> partial(context, "Fabric event info alpha registered."))))
                        .then(CommandManager.literal("refresh")
                                .executes(context -> partial(context, "Fabric event refresh alpha registered.")))
                        .then(CommandManager.literal("resolve")
                                .then(CommandManager.argument("eventId", StringArgumentType.word())
                                        .executes(context -> partial(context, "Fabric event resolve alpha registered."))))
                        .then(CommandManager.literal("ignore")
                                .then(CommandManager.argument("eventId", StringArgumentType.word())
                                        .executes(context -> partial(context, "Fabric event ignore alpha registered.")))))
                .then(CommandManager.literal("projects")
                        .then(CommandManager.literal("list")
                                .executes(context -> partial(context, "Fabric project chains alpha registered.")))
                        .then(CommandManager.literal("info")
                                .then(CommandManager.argument("projectId", StringArgumentType.word())
                                        .executes(context -> partial(context, "Fabric project info alpha registered."))))
                        .then(CommandManager.literal("activate")
                                .then(CommandManager.argument("projectId", StringArgumentType.word())
                                        .executes(context -> partial(context, "Fabric project activate alpha registered."))))
                        .then(CommandManager.literal("status")
                                .executes(context -> partial(context, "Fabric project status alpha registered."))))
                .then(CommandManager.literal("emergency")
                        .then(CommandManager.literal("list")
                                .executes(context -> partial(context, "Fabric emergency repairs alpha registered.")))
                        .then(CommandManager.literal("info")
                                .then(CommandManager.argument("repairId", StringArgumentType.word())
                                        .executes(context -> partial(context, "Fabric emergency info alpha registered."))))
                        .then(CommandManager.literal("repair")
                                .then(CommandManager.argument("repairId", StringArgumentType.word())
                                        .executes(context -> partial(context, "Fabric emergency repair alpha registered."))))
                        .then(CommandManager.literal("verify")
                                .then(CommandManager.argument("repairId", StringArgumentType.word())
                                        .executes(context -> partial(context, "Fabric emergency verify alpha registered.")))))
    ...
    private static int partial(CommandContext<ServerCommandSource> context, String message) {
