...
```text
build/libs/blockforge-connector-fabric-1.2.2-alpha.1.jar
```
...
survival materials, inventory transactions, and undo material refunds. Fabric
and Forge Alpha are intentionally smaller so each loader adapter can stabilize
before deeper parity work begins.
