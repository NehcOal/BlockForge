...
- No manual Minecraft Fabric regression test has been run yet.
...
inventory transactions, and undo material refunds. Fabric Alpha is intentionally
smaller and command-only so the loader adapter can stabilize before feature
parity work begins.
